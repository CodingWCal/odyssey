...
### ODY-121 · Date-picker inputs are smashed together on mobile — S, sonnet (P1) — 🔴 MVP — ✅ DONE (2026-09-23, owner-verified)
...
### ODY-131 · Trip overview: reduce mobile spacing — S, haiku (P2) — ✅ DONE (2026-09-23, resolved as ODY-121 round 2)
...
> **Resolved:** the owner's screenshot showed the Add-event modal's Starts/Ends time-input row overflowing the container edge — not a spacing/whitespace issue in a "trip overview" area, but the exact same start/end-input overflow bug ODY-121 already targeted, still present on wider phones (Pro Max-class, 428–430px) because that fix's 400px breakpoint didn't cover them. Folded into and fixed under **ODY-121's "round 2"** entry above rather than duplicated here — see that entry for the root cause and fix.
- **Acceptance:** met — see ODY-121.
