...
- **Next up:** **ODY-108**, the full-app UI/UX design audit — the last remaining audit, and the only item left from the 2026-08-08 review's "run before the polish they'd feed" list. Or pick up a fresh P2/P3 ticket (ODY-064 dead-code dedupe, ODY-075's mobile-drawer follow-up, ODY-067 packing list).
