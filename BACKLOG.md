...
- ~~**Next up:** no audits left in the queue. Pick from: **ODY-117** (token drift) · the landing-page fixes the audit named but didn't auto-apply (F01, F07) · or a fresh P2/P3 ticket (ODY-064, ODY-075, ODY-067 packing list).~~ — ✅ mostly shipped since (2026-08-30 reconciliation): **ODY-117** done 2026-08-11, **ODY-064** done 2026-08-11, **ODY-075** done 2026-08-09, and **F07** (landing icon swap) done 2026-08-09 — each feature card already uses its own purpose-built icon (`Icons.itinerary/map/budget/members/note/weather`), see `docs/ody-108-design-audit.md` F07. Only **F01** and **ODY-067 Stage B** are still open from that list.
- ~~**Next up (2026-08-30):** … **ODY-085** (post-invite "you're in" welcome) …~~ — **ODY-085 shipped 2026-08-30** (`JoinWelcome`, cookie-persisted dismiss). **ODY-109 shipped 2026-08-30** (bulk "free" fills + Clear all + mobile sticky day column — ticket now fully done). Still open and shippable here (no browser needed): **ODY-118 F2** (`:focus-visible` rings on the seamless inline note editors). Needs a rendered browser — owner or a browser-capable session: **ODY-118 F10** + **ODY-022** axe/contrast sweep on the 5 main routes · **ODY-097** budget IA/mobile judgment. Owner content call, not code: **F01** (the fabricated "4,200 travelers" stat + invented "Maya R." testimonial — remove / replace / wait for real data).
