...
### ODY-113 · Clearing an availability cell doesn't delete the underlying row — S, haiku
...
- **Next up:** ODY-113 (small, mechanical — the clear/delete gap) is the natural next pickup since it's fresh context from this session; otherwise resume the numbered order above at step 3 (ODY-062/063).
