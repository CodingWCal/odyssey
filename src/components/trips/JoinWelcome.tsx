 ...
 * on a trip they were invited to (ODY-085). The layout gates it on joinedAt
 * recency and role, so this only renders for a freshly-joined non-owner.
 * Dismiss is session-only (no localStorage), matching FirstSteps.
 */
